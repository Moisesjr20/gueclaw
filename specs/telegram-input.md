...
- Como acionar o Whisper local a partir do backend Node.js (se GueClaw ainda for Node). *Decisão pendente: usar bridge FFI, ou Child Process nativo na máquina.*
